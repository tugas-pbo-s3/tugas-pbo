...
class Kelom extends Product {
  ...
  factory Kelom.fromMap(Map<String, dynamic> map) {
    return Kelom(
  ...
  factory Kelom.fromJson(String source) => Kelom.fromMap(json.decode(source));
