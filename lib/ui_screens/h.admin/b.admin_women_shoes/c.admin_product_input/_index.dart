...
part 'widgets/b.admin_women_shoes_input.fab.dart';
part 'widgets/c.admin_women_shoes_input.name.dart';
part 'widgets/d.admin_women_shoes_input.price.dart';
part 'widgets/e.admin_women_shoes_input.description.dart';
part 'widgets/f.admin_women_shoes_input.quantity.dart';
part 'widgets/g.admin_women_shoes_input.merk.dart';
part 'widgets/h.admin_women_shoes_input.category.dart';
part 'widgets/i.admin_women_shoes_input.size.dart';
part 'widgets/j.admin_women_shoes_input.color.dart';
part 'widgets/k.admin_women_shoes_input.images.dart';
part 'widgets/l.admin_women_shoes_input.submit.dart';

AdminWomenShoesInputData get _dt => Data.adminProductInput.st;
AdminWomenShoesInputCtrl get _ct => Ctrl.adminProductInput;
