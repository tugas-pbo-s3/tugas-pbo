...
class AdminKelomDetailTileEditSizes extends StatelessWidget {
  final Kelom? womenShoes;

  const AdminKelomDetailTileEditSizes({super.key, required this.womenShoes});
    ...
    return ListTile(
      ...
      trailing: IconButton(
        onPressed: () {
          nav.toDialog(
            AlertDialog(
              title: const Text('Edit Ukuran Kelom'),
              actions: [
                TextButton(
                  onPressed: () {
                    nav.back();
